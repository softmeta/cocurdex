...
1. Download the build for your platform from the [Download](/download/) page.
...
1. Install the agent CLI you want (for example `claude`, `codex`, `opencode`, or `grok`), **or** use the built-in **Pi** (`pi`) runtime when you only need chat-style work without native write.
