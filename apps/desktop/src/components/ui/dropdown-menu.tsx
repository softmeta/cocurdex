...
function DropdownMenuCheckboxItem({
  ...
  return (
    ...
    >
      <span
        className="pointer-events-none absolute end-2 flex translate-y-px items-center justify-center"
