...
const fallbackApi: DesktopApi = {
  ...
  saveAgentRole: async (payload) => ({
    id: payload.id ?? "role-dev",
    name: payload.name,
  ...
  deleteAgentRole: async () => {},
  listWorkflowDefinitions: async () => [],
  getWorkflowDefinition: async () => null,
  saveWorkflowDefinition: async (payload) => ({
    ...payload,
    builtin: false,
    createdAt: "",
    updatedAt: "",
  }),
  duplicateWorkflowDefinition: async (definitionId) => ({
    id: definitionId,
    name: "copy",
    builtin: false,
    revision: {
  ...
  getWorktreeSettings: async () => ({
    rootPath: null,
    fetchBeforeCreate: false,
    resolvedRootPath: "",
  }),
  saveWorktreeSettings: async (settings) => ({
    ...settings,
    resolvedRootPath: settings.rootPath ?? "",
  }),
  ...
  browserUpdateHtml: async () => false,
  browserOpenHtml: async () => {
    throw new Error("HTML browser preview requires the desktop app");
  },
  browserReload: async () => {},
  browserStop: async () => {},
  browserGoBack: async () => {},
  ...
  onBrowserAnnotation: () => () => {},
  browserListTabs: async () => ({ tabs: [], activeId: null }),
  browserActivateTab: async () => {},
  browserCloseTab: async () => ({ tabs: [], activeId: null }),
  onBrowserTabs: () => () => {},
